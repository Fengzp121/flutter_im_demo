...
class DragContainer extends StatefulWidget {
  ...
  Function(double y) endDragAction;
  DragContainer(
      {Key key,
...
//    }
  ...
  void _handleDragEnd(DragEndDetails details) async {
    ...
    double start;
    double end;
    if (offsetDistance <= maxOffsetDistance - 300) {
    ...
    ///自己滚动
    await animalController.forward();
    //需要看下什么时候才调用这个东西
    widget.endDragAction(offsetDistance);
  }
